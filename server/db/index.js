...
mongoose.connect(`mongodb+srv://${process.env.USERNAME}:${process.env.PSWD}@${process.env.DB}.fan4l.mongodb.net/sql?retryWrites=true&w=majority`,{useNewUrlParser: true});
